=== Html5 Audio Player ===
Tags: Player, mp3 player,audio player, audio , html5 player, podcast ,audio podcast , radio,audio, audio player, embed, media, media player, mp3, mp3 player, music, music player, ogg, player, podcast, sound, wav radio player, sound player, sound, announce    
...
Html5 Audio Player is a awesome audio player plugin for your wordpress website. 

== Description ==

You can easily integrate html5 audio player in your wordress website using this plugin. 

Wanna see how it works? Click here: http://1infosoft.com/products/html5-audio-player-demo/
...
= What audio type can i play? =

You can play mp3, oog and wav sound
